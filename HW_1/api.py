...
api = Api(app, version='1.0', title='MlOps HW_1')
...
create_params = api.model('create', {
    ...
    'model_class': fields.String(required=True, description='Model class (LinReg/Lasso for Regression, LogReg/RF for Classification)', example='Lasso'),
